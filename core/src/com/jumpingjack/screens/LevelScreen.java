package com.jumpingjack.screens;
...
public class LevelScreen extends BaseScreen {
    ...
    public void update(float dt) {
        ...
        for (BaseActor actor : BaseActor.getList(mainStage, Solid.class.getCanonicalName())) {
            ...
            if (solid instanceof Platform) {
                ...
                // when jumping, agter passing through, re-enable the solid
                if (jack.isJumping() && !jack.overlaps(solid))
            ...
            if (jack.overlaps(solid) && solid.isEnabled()) {
                ...
                if (offset != null) {
                    ...
                    else  // colided in Y direction
                        jack.velocityVec.y = 0;

                }
            }

            for (BaseActor key : BaseActor.getList(mainStage, Key.class.getCanonicalName())) {
